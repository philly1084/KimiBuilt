...
const BLUEPRINT_DIRECTION_MAP = {
  ...
  'research-note': ['signal-journal', 'editorial-feature'],
  'research-methodology': ['field-guide', 'signal-journal'],
  'research-literature': ['studio-casefile', 'signal-journal'],
  'research-brief': ['boardroom-brief', 'signal-journal'],
  'html-dashboard-kpi': ['systems-minimal', 'campaign-sprint'],
  'html-dashboard-operational': ['systems-minimal', 'editorial-feature'],
  'html-dashboard-funnel': ['analyst-briefing', 'editorial-feature'],
  'html-article': ['editorial-feature', 'launch-manifesto'],
  'html-product-page': ['studio-casefile', 'campaign-sprint'],
  'html-technical-spec': ['field-guide', 'systems-minimal'],
  'pdf-whitepaper': ['boardroom-brief', 'signal-journal'],
  'pdf-audit-report': ['boardroom-brief', 'analyst-briefing'],
  'pdf-executive-brief': ['boardroom-brief', 'signal-journal'],
