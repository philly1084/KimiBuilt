        ...
        const prompt = [
            ...
            ...(toolPolicy?.rolePipeline
                ? [
                    ...
                    'For website, dashboard, landing-page, app workspace, frontend demo, HTML prototype, and UI mockup builds, apply the Impressive Frontend Websites quality bar from the active role contract: specific first viewport, real controls/states/interactions, relevant assets, responsive layout, opened-state contrast, browser screenshots, and at least one refinement pass for non-trivial work.',
            ...
            'For sandbox website/dashboard/front-end artifacts, require the builder to follow the Impressive Frontend Websites standard: request-matched visual direction, relevant imagery/assets, real controls and states, stable responsive layout, readable opened dropdown/menu/popover/dialog states, and a refinement pass after initial screenshot for non-trivial pages.',
    ...
    buildRuntimeInstructions({
        ...
        if (toolPolicy?.rolePipeline) {
            ...
            if (toolPolicy.rolePipeline.requiresSandbox && allowedToolIds.includes('code-sandbox')) {
                ...
                parts.push('Apply the Impressive Frontend Websites standard for sandbox frontend builds: infer the brief, make the first viewport specific, include relevant assets and real controls/states/interactions, avoid generic placeholders and one-note palettes, inspect opened UI states, and refine after the first render when the work is non-trivial.');
            }
