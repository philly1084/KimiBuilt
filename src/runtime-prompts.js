function buildContinuityInstructions(extra = '') {
    return [
        ...
        'Use file-write only for local runtime files. For remote hosts or deployed servers, prefer remote-command and k3s-deploy. Do not use docker-exec for the host unless the user explicitly says Docker is available there.',
